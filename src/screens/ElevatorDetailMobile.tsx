 ...
 */
export function ElevatorDetailMobile({ viaQr }: { viaQr?: boolean }) {
  const { t } = useTranslation();
  const { technical: tech, inspection: insp, manufacturing: man, classification: cls } = elevator;
  ...
  const facts: Array<[string, React.ReactNode]> = [
    ...
    [t("elevator.fields.speedMps"), `${tech.speed_mps} m/s`],
